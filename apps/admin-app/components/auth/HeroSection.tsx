...
const heroTexts = {
  login: {
    title: 'Welcome Back',
    subtitle: 'Sign in to manage your hostel bookings and explore new destinations.'
  },
  signup: {
    title: 'Join AllmapHostels',
    subtitle: 'Create an account to book hostels worldwide and unlock exclusive travel perks.'
  }
};

export const HeroSection: React.FC<HeroSectionProps> = ({ activeTab, onSwitchTab }) => {
  return (
    <div className="w-full md:w-1/2 bg-[#1a1a1a] p-8 md:p-12 hidden lg:flex flex-col justify-between relative overflow-hidden">
      <div className="flex justify-between items-center">
        ...
        <div className="text-white text-sm">
          ...
          <button 
            onClick={() => onSwitchTab(activeTab === 'login' ? 'signup' : 'login')}
